...
const TABS: { id: TabId; label: string; metric: string }[] = [
  { id: "contributors", label: "Lojas", metric: "contributions" },
            ...
            <div className="flex border-[2px] border-border">
              ...
              {/* <Link
                ...
                style={{
                  ...
                  backgroundColor:
                    mode === "game" ? "rgba(200, 230, 74, 0.1)" : "transparent",
                }}
              >
                Game
              </Link> */}
          ...
          {mode === "dailies" ? (
            ...
            <>
              ...
              <div className="mt-6 flex flex-wrap justify-center gap-1">
                {TABS.filter((t) => t.id !== "recruiters" || hasRecruiters).map(
                  (tab) => (
                    <Link
                      key={tab.id}
